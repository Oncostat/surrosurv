...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: optimx}}\begin{alltt}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'survival' was built under R version 3.3.2}}\end{kframe}\begin{figure}
...
## Plackett.adj   -4.87 0.01
## Hougaard.unadj -0.61 0.54
## Hougaard.adj   -1.31 0.27
## PoissonT       -0.17 0.84
## PoissonTI      -0.65 0.52
## PoissonTIa     -1.12 0.33
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##             1     2     3     4     5     6    
## obsBeta -0.31 -0.21 -0.09 -0.02 -0.22 -0.34 ...
## predict -0.69 -0.45  0.08 -0.18 -0.03 -0.38 ...
## lwr     -1.22 -0.99 -0.76 -0.80 -0.60 -0.85 ...
## upr     -0.15  0.08  0.92  0.44  0.55  0.09 ...
## kTau     0.51  0.51  0.51  0.52  0.52  0.52 ...
## R2       0.70  0.70  0.47  0.43  0.62  0.74 ...
\end{verbatim}
\end{kframe}
\end{knitrout}
