...
%% Use the \inline{}, \inline{} and \inline{} commands.
...
\begin{figure}
\includegraphics[width=\textwidth]{./poissonize-1} \caption{Overall survival curves in the advanced GASTRIC meta-analysis. Comparison between the survival probability obtained using the Breslow estimator in the Cox model (solid lines) and those obtained using the auxiliary Poisson model (dashed lines).}\label{fig:poissonize}
\end{figure}
