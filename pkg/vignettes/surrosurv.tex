...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# - Estimating model: Clayton\ (5.1 mins)}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# - Estimating model: Plackett\ (4.6 mins)}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# - Estimating model: Hougaard\ (6.7 mins)}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# - Data poissonization\ (3.9 secs)}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# - Estimating model: Poisson T\ (1.2 mins)}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# - Estimating model: Poisson I\ (1.9 mins)}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# - Estimating model: Poisson TI\ (4.2 mins)}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# - Estimating model: Poisson TIa\ (2.2 mins)}}\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##                    maxSgrad        minHev      minREev
## Clayton unadj  1.499287e+00 -6.118457e+00          ---
## Clayton adj    1.499287e+00 -6.118457e+00 1.010837e-02
## Plackett unadj 3.842114e+02 -5.235651e+00          ---
## Plackett adj   3.842114e+02 -5.235651e+00 8.895006e-03
## Hougaard unadj 1.416081e+01  7.729161e-01          ---
## Hougaard adj   1.416081e+01  7.729161e-01 8.018467e-03
## PoissonT       2.801471e-05  1.291134e+02 1.116468e-13
## PoissonI       1.128738e-05  6.799117e+01          ---
## PoissonTI      1.541625e-05  6.697215e+01 2.041620e-02
## PoissonTIa     1.995408e-04 -1.456489e+07 1.024375e-01
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}
\includegraphics[width=\maxwidth]{figs/figpredictions-1} \caption[Predictions for the advanced GASTRIC meta-analysis as computed by the adjusted Clayton copula model, which had poor convergence metrics, and by the Poisson TI model, which was deemed to have converged]{Predictions for the advanced GASTRIC meta-analysis as computed by the adjusted Clayton copula model, which had poor convergence metrics, and by the Poisson TI model, which was deemed to have converged. HR = hazard ratio.}\label{fig:predictions}
\end{figure}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Parallel computing on 20 cores (the total number of trials)}}\end{kframe}
\end{knitrout}
...
## kTau     0.60  0.60  0.61  0.60  0.60  0.605 ...
## R2       0.46  0.45  0.42  0.46  0.43  0.411 ...
## 
##    Poisson TI 
##             1     2     3     4     5     6    
## obsBeta -0.31 -0.21 -0.09 -0.02 -0.22 -0.34 ...
## predict -0.69 -0.40  0.08 -0.11 -0.06 -0.38 ...
## lwr     -1.22 -1.00 -0.76 -0.68 -0.72 -0.85 ...
## upr     -0.15  0.20  0.92  0.47  0.61  0.09 ...
## kTau     0.51  0.52  0.51  0.51  0.52  0.52 ...
## R2       0.70  0.65  0.47  0.60  0.48  0.74 ...
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\includegraphics[width=\maxwidth]{figs/figloocv-1} \caption[Leave-one-trial-out cross-validation results for the advanced
GASTRIC meta-analysis]{Leave-one-trial-out cross-validation results for the advanced
GASTRIC meta-analysis. The symbol `\textbf{X}' means that the surrogacy model could
not be fitted due to numerical problems. Vertical lines are the 95\% prediction intervals (PI) of the treatment effect on overall survival (OS). Dots are the observed treatment effects on OS (green = within the PI, magenta = out of the PI).}\label{fig:loocv}
\end{figure}
