...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The \pkg{surrosurv} package can compute four reduced versions 
...
These parameters are passed to the function \code{poissonize()},
...
The argument \code{parallel} is a logical for allowing or not such a parallelization,
  whereas \code{nCores} allows specifying the number of cores to use.
